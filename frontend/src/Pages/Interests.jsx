...
const Interests = () => {
  ...
  const popularInterests = [
    'Technology', 'Music', 'Movies', 'Sports', 
  ...
  const handleAddCustomInterest = () => {
    if (customInterest.trim() && !customInterests.includes(customInterest.trim())) {
      ...
      setSelectedInterests(new Set([...selectedInterests, customInterest.trim()]));
      setCustomInterest('');
    }
  };
  ...
  const handleStartChat=()=>{
    ...
    console.log("Starting anonymous chat with interests:",[...selectedInterests])
    navigate('/anonymous-chat',{state:{interests:[...selectedInterests]}})
  }
      ...
      <div style={cardStyle}>
        ...
        <div style={{marginBottom:'32px',display:'flex',justifyContent:'center'}}>
            <button
                ...
                style={{
                    ...buttonStyle,
                    backgroundColor:selectedInterests.size<2 ? '#9ca3af' : '#7c3aed',
